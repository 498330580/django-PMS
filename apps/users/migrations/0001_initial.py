    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('男', '男'), ('女', '女')], help_text='默认为“男”,系统会根据身份证自动判断', max_length=5, verbose_name='性别')),
                ('birthday', models.DateField(help_text='系统会根据身份证自动填写', verbose_name='出生日期')),
                ...
                ('idnumber', models.CharField(db_index=True, help_text='如果最后一位为X请大写', max_length=18, verbose_name='身份证')),
                ...
                ('politics', models.CharField(choices=[('群众', '群众'), ('共青团员', '共青团员'), ('中共党员', '中共党员')], default='群众', max_length=10, verbose_name='政治面貌')),
                ...
                ('zhuangtai', models.CharField(choices=[('在岗', '在岗'), ('离职', '离职'), ('调离', '调离')], default='在岗', max_length=6, verbose_name='人员状态')),
                ('beizhu', models.CharField(default='', max_length=500, verbose_name='备注')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('bianzhi', models.ForeignKey(blank=True, help_text='本信息由管理员填写', null=True, on_delete=django.db.models.deletion.SET_NULL, to='classification.Organization', verbose_name='编制位置')),
                ('category', models.ForeignKey(blank=True, help_text='本信息由管理员填写', null=True, on_delete=django.db.models.deletion.SET_NULL, to='classification.CategoryType', verbose_name='人员类别')),
                ('dadui', models.ForeignKey(blank=True, help_text='本信息由管理员填写', null=True, on_delete=django.db.models.deletion.SET_NULL, to='classification.DaDuiType', verbose_name='所属大队')),
                ...
                ('economics', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='classification.Economics', verbose_name='家庭经济状态')),
                ('gangweiname', models.ForeignKey(blank=True, help_text='本信息由管理员填写', null=True, on_delete=django.db.models.deletion.SET_NULL, to='classification.PostName', verbose_name='岗位名称')),
                ('gangweitype', models.ForeignKey(blank=True, help_text='本信息由管理员填写', null=True, on_delete=django.db.models.deletion.SET_NULL, to='classification.PostType', verbose_name='岗位类别')),
                ('jiediao', models.ForeignKey(blank=True, help_text='本信息由管理员填写', null=True, on_delete=django.db.models.deletion.SET_NULL, to='classification.Borrow', verbose_name='借调位置')),
                ('jiguan', models.ForeignKey(blank=True, help_text='系统会根据身份证自动填写', null=True, on_delete=django.db.models.deletion.SET_NULL, to='classification.DiZhi', verbose_name='籍贯')),
                ('sources', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='classification.Sources', verbose_name='经济来源')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
                ('veteran', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='classification.DemobilizedType', verbose_name='退役类别')),
                ('zhongdui', models.ForeignKey(blank=True, help_text='本信息由管理员填写', null=True, on_delete=django.db.models.deletion.SET_NULL, to='classification.ZhongDuiType', verbose_name='所属中队（小组）')),
            ],
            options={
                'verbose_name': '个人档案',
